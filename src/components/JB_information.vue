  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-5 text-center">
        <img :src=JB_img class="img-thumbnail border-0" />
      </div>
      <div class="col-sm-7">
    ...
    <div class="row pt-4">
      ...
      <div v-for="item of JB_pic" class="col-sm-6 text-center">
        <img class="img-thumbnail border-0 rounded shadow" :src='item.pic' />
...
const startoptions = ref([
  ...
  { id: id++, title: '虛擬系統(帶破解)', content: '該系統即為本機的虛擬系統，建立在記憶卡上，可用來遊玩各類第三方程序,點選後會讀取記憶卡上的虛擬系統' , pic: new URL('../img/For-Start-Option/JB.png', import.meta.url).href}
])
...
const JB_pic = ref([
  { id: id++, detail: '螢幕底部會有一個跑條向右跑，如未按下音量小聲鍵則會自動進入虛擬系統', pic: new URL('../img/For-Start-Option/logo.png', import.meta.url).href},
  { id: id++, detail: '進入開機選單後的畫面', pic: new URL('../img/For-Start-Option/log2.png', import.meta.url).href}
])
